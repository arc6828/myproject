                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Year</th><th>Price</th><th>Isbn</th><th>Author Id</th><th>Publisher Id</th><th>Photo</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($book as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->year }}</td><td>{{ $item->price }}</td><td>{{ $item->isbn }}</td><td>{{ $item->author_id }}</td><td>{{ $item->publisher_id }}</td>
                                        <td>
